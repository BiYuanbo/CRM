<%@ page import="com.bjpowernode.workbench.bean.Activity" %>
...
<script type="text/javascript">
	...
	$(function(){
		...
		//为市场信息编辑按钮绑定事件，打开编辑操作的模态窗口
		$("#infEditBtn").click(function (){
			var id = $("#hidden-name").val()
...
<body>
	<input type="hidden" id="hidden-name" value="${a.id}">
    ...
    <div class="modal fade" id="editActivityModal" role="dialog">
        <div class="modal-dialog" role="document" style="width: 85%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" id="infUpdateBtn">更新</button>
                </div>
            </div>
        </div>
    </div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" id="infEditBtn"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
			<button type="button" class="btn btn-danger" id="infDeleteBtn"><span class="glyphicon glyphicon-minus"></span> 删除</button>
		</div>
	</div>
