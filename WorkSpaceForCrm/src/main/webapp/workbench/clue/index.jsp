...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function (){
			...
			* 点击查询按钮的时候，应该将搜索框中的信息保存起来，保存到隐藏域中*/
			...
			$("#hidden-cpyPhone").val($.trim($("#search-cpyPhone").val()));
	...
	* pageSize：每页展现的记录数*/
	function pageList(pageNo,pageSize){
		...
		$("#search-cpyPhone").val($.trim($("#hidden-cpyPhone").val()));
		...
		$.ajax({
			...
			data:{
				...
				"cpyPhone":$.trim($("#search-cpyPhone").val()),
...
<body>
	...
	<input type="hidden" id="hidden-cpyPhone">
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" type="text" id="search-cpyPhone">
				    </div>
				  </div>
